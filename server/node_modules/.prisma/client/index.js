...
const config = {
  ...
  "inlineSchema": "generator client {\r\n    provider = \"prisma-client-js\"\r\n}\r\n\r\ndatasource db {\r\n    provider = \"mongodb\"\r\n    url = env(\"DATABASE_URL\")\r\n}\r\n\r\nmodel User {\r\n    id String @id @default(auto()) @map(\"_id\") @db.ObjectId\r\n    name  String?\r\n    email String @unique\r\n    image String?\r\n    VisitDate Json[]\r\n    favRoomID String[] @db.ObjectId\r\n    ownedRooms Room[] @relation(\"Owner\")\r\n}\r\n\r\nmodel Room {\r\n    id String @id @default(auto()) @map(\"_id\") @db.ObjectId\r\n    title String\r\n    description String\r\n    price Int\r\n    address String\r\n    city String\r\n    country String\r\n    image String\r\n    facilities Json\r\n    userEmail String\r\n    owner User @relation(\"Owner\", fields: [userEmail], references: [email])\r\n    createdAt DateTime @default(now())\r\n    updateAt DateTime @updatedAt\r\n\r\n    @@unique(fields: [address, userEmail])\r\n}",
  "inlineSchemaHash": "fde29f9efb92c55e23286ea92767109c0fc4417eb348d84add3c4bc74ed45a31",
  "copyEngine": true
}
